...
//并使用默认的文档解析器TextDocumentParser对文档进行解析
        Document document = FileSystemDocumentLoader.loadDocument("/Users/david/project/agent/xiaozhi-qa/src/main/resources/medical-prompt-template.txt");
...
//并使用默认的文档解析器对文档进行解析(TextDocumentParser)
        Document document = FileSystemDocumentLoader.loadDocument("/Users/david/project/agent/xiaozhi-qa/src/main/resources/knowledge/人工智能.md");
